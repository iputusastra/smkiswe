	...
	<div id="container">
					...
					<div class="navbar-collapse collapse">
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li>
								<a href="#">Profil</a>
								<ul class="dropdown">
									<li><a href="?hal=profil" onclick="load('profil')">Profil</a></li>
									<li><a href="?hal=struktur" onclick="load('struktur')">Struktur Organisasi</a></li>
									<li><a href="?hal=guru" onclick="load('guru')">Tentang Pengajar</a></li>
                                    <li><a href="?hal=sarana" onclick="load('sarana')">Sarana Prasarana</a></li>
                            ...
                            <li>
								...
								<ul class="dropdown">
									<li><a href="?hal=oto" onclick="load('tkr')">Teknik Kendaraan Ringan</a></li>
                                    <li><a href="?hal=rek" onclick="load('rpl')">Rekayasa Perangkat Lunak</a></li>
							...
							<li>
								<a href="#">My Apps</a>
								<ul class="dropdown">
									<li><a href="?hal=absen" onclick="load('absen')">Absen Online</a></li>
                                    <li><a href="?hal=sinos" onclick="load('sinos')">Nilai Online</a></li>
                                    <li><a href="?hal=eperpus" onclick="load('eperpus')">E-Library</a></li>
									<li><a href="?hal=modol" onclick="load('modol')">Modul Online</a></li>
									
								</ul>
							</li>
                            <li>
								<a href="?hal=galery" onclick="load('galery')">Galery</a>
							</li>
							
							<li>
								<a href="?hal=loker" onclick="load('loker')">Loker</a>
								
							</li>
							<li><a href="?hal=testimoni" onclick="load('testimoni')">Testimoni</a></li>
						</ul>
                        <!-- End Navigation List -->
					</div>
				</div>
		...
		<div id="content">
            ...
            <?php
				...
				$hal=$_GET['hal'];	
				$file="pag/$hal.php";
					//ini nanti bisa manggil halaman sesuai nama file
				...
				if (!file_exists($file)){
					...
					include ("pag/dashboard.php"); //halaman utama
					}
			?>
