    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <strong>Admin SMKIsWe</strong> <br/>SMK Islamiyah Widodaren
            </h1>
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small> 2014 </span> &copy; <a href="" target="_blank">@iputusastra</a></small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
