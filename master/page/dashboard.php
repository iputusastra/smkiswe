...
$sql1=$conn->query("SELECT count(*) guru FROM guru");
$a=$sql1->fetch_assoc();

$sql2=$conn->query("SELECT count(*) artikel FROM artikel");
$b=$sql2->fetch_assoc();

$sql3=$conn->query("SELECT count(*) komentar FROM komentar");
$c=$sql3->fetch_assoc();

$sql4=$conn->query("SELECT count(*) loker FROM loker");
$d=$sql4->fetch_assoc();
...
<div class="row">
    <div class="col-sm-12 col-lg-3">
        <a href="javascript:void(0)" class="widget" onclick="load('berita')">
            <div class="widget-content widget-content-mini text-right clearfix">
                <div class="widget-icon pull-left themed-background">
                    <i class="gi gi-file text-light-op"></i>
                </div>
                <h2 class="widget-heading h3 text-danger">
                    <strong><span data-toggle="counter" data-to="<?php echo $b['artikel']; ?>"></span></strong>
                </h2>
        ...
        <a href="javascript:void(0)" class="widget">
            <div class="widget-content widget-content-mini text-right clearfix">
                ...
                <h2 class="widget-heading h3 text-default">
                    <strong><span data-toggle="counter" data-to="<?php echo $a['guru']; ?>"></span></strong>
                </h2>
                <span class="text-muted">GURU & KARYAWAN</span>
            </div>
        </a>
    </div>
    <div class="col-sm-12 col-lg-3">
        <a href="javascript:void(0)" class="widget" onclick="load('pembayaran')">
            <div class="widget-content widget-content-mini text-right clearfix">
                ...
                <h2 class="widget-heading h3 text-danger">
                    <strong><span data-toggle="counter" data-to="<?php echo $d['loker']; ?>"></span></strong>
                </h2>
                <span class="text-muted">LOKER</span>
            </div>
        </a>
    </div>
    <div class="col-sm-12 col-lg-3">
        <a href="javascript:void(0)" class="widget" onclick="load('pembayaran')">
            <div class="widget-content widget-content-mini text-right clearfix">
                ...
                <h2 class="widget-heading h3 text-success">
                    <strong><span data-toggle="counter" data-to="<?php echo $c['komentar']; ?>"></span></strong>
                </h2>
