                      ...
                      <?php
                        include "con.php"; 
                            if(isset($_POST['submit'])){
                               $cari = $_POST['cari'];
                                 # code...
                                $result=mysql_query("SELECT a.id_b, a.isi, a.judul,a.id_user,a.tgl_upload,a.gambar,a.kategori, a.enabled, c.nama FROM artikel a left join user c on a.id_user=c.id_user where a.isi LIKE '%$cari%' or a.judul LIKE '%$cari%' or a.kategori LIKE '%$cari%' and a.enabled=1 order by tgl_upload DESC");
