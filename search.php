					...
					<div class="col-md-9 blog-box">
                      <?php
                        include "con.php"; 
                            if(isset($_POST['submit'])){
                               $cari = $_GET['cari'];
                                 # code...
                                $result=mysql_query("SELECT a.id_b, a.isi, a.judul,a.id_user,a.tgl_upload,a.gambar,a.kategori, a.enabled, c.nama FROM artikel a left join user c on a.id_user=c.id_user where a.isi LIKE '%$cari%' or a.judul LIKE '%$cari%' or a.kategori LIKE '%$cari%' and enabled=1 order by tgl_upload DESC");

                             }else{
                                 $result=mysql_query("SELECT a.id_b, a.isi, a.judul,a.id_user,a.tgl_upload,a.gambar,a.kategori, a.enabled, c.nama FROM artikel a left join user c on a.id_user=c.id_user where a.enabled=1 order by tgl_upload DESC");
                             }
                             //output
                      ...
                      ?>  
						...
						<div class="blog-post image-post">
                            <!-- Post Thumb -->
                        	<div class="post-head">
                            	<a class="lightbox" title="This is an image title" href="images/berita/<?php echo $row['gambar'];?>">
							...
							<div class="post-content">
								...
								<a class="main-button" href="index.php?hal=berita&id_l=<?php echo $row['id_l'];?>">Read More <i class="icon-right-small"></i></a>
							</div>
						</div>
                        <!-- End Post -->
                       <?php
