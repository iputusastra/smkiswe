		...
		<div class="tp-banner" >
			<ul>	<!-- SLIDE  -->
				<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
					...
					<div class="tp-caption customin customout"
						...
						data-endspeed="500"
						data-endeasing="Power4.easeIn"
						style="z-index: 3"><img src="images/logosmki.png" alt="">
					</div>
				...
				<li data-transition="slidedown" data-slotamount="7" data-masterspeed="1000" >
					...
					<div class="tp-caption lfb skewtoleft"
						...
						data-endspeed="400"
						data-endeasing="Power1.easeIn"
						style="z-index: 11"><img src="images/slide-01-image-02.png" alt="">
					</div>
					...
					<div class="tp-caption lfb skewtoleft"
						...
						data-endspeed="400"
						data-endeasing="Power1.easeIn"
						style="z-index: 12"><img src="images/slide-01-image-01.png" alt="">
					</div>
			...
			Transition Builder
					...
					<div class="tp-caption customin skewtoright"
						...
						data-endspeed="600"
						data-endeasing="Power4.easeIn"
						style="z-index: 15"><img src="images/slide-01-image-02.png" alt="">
					</div>
					...
					<div class="tp-caption customin skewtoright"
						...
						data-endspeed="600"
						data-endeasing="Power4.easeIn"
						style="z-index: 16"><img src="images/slide-01-image-01.png" alt="">
					</div>
			...
			data-endspeed="600"
				...
				<li data-transition="zoomin" data-slotamount="7" data-masterspeed="600" >
					...
					<div class="tp-caption sft customout"
						...
						data-endspeed="500"
						data-captionhidden="on"
						style="z-index: 7"><img src="images/.png" alt="">
					</div>
					...
					<div class="tp-caption customin customout"
						...
						style="z-index: 8"><img src="images/logosmki.png" alt="">
					</div>
				</li>
				<!-- SLIDE  -->
				<li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
					...
					<div class="tp-caption customin fullscreenvideo"
						...
						data-autoplay="false"
						data-autoplayonlyfirsttime="false"
						style="z-index: 2"><iframe src='' width='100%' height='100%' style='width:100%px;height:100%px;'></iframe>
					</div>
				</li>
			</ul>
